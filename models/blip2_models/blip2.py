...
class Blip2Base(BaseModel):
    ...
    def init_tokenizer(cls, truncation_side="right"):
        tokenizer = BertTokenizer.from_pretrained("/share/user/2309104036/MA-LMM-main/lavis/models/blip2_models/bert-base-uncased", truncation_side=truncation_side)
    ...
    def init_Qformer(cls, num_query_token, vision_width, cross_attention_freq=2, memory_bank_length=0, num_frames=0):
        encoder_config = BertConfig.from_pretrained("/share/user/2309104036/MA-LMM-main/lavis/models/blip2_models/bert-base-uncased")
        ...
        Qformer = BertLMHeadModel.from_pretrained(
            "/share/user/2309104036/MA-LMM-main/lavis/models/blip2_models/bert-base-uncased", config=encoder_config
        )
    ...
    #     # TODO:下面这一行判断和同级的else是后加的，尝试直接初始化，257行根据报错，安全方面，now只更改权重
    #     if url_or_filename:
        ...
        # #TODO:指的就是这一块奥
        # else:
        #     logging.info("No pretrained weights provided. Initializing model from scratch.")
