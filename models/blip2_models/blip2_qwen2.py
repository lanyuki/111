...
class Blip2Qwen2Model(Blip2Base):
    ...
    def __init__(
            ...
            freeze_vit=True,
            num_query_token=32,
            qwen_model="qwen/Qwen2-7B-Instruct",  # 使用 Qwen-2 模型名称
            prompt="",
            max_txt_len=32,
        ...
        # TODO: self.emo_clss_proj = nn.Linear(2560, 1408)  # 适配情感投影层,我又把
        self.emo_clss_proj = nn.Linear(3584, 1408)  # 适配情感投影层
    ...
    def forward(self, samples):
        ...
        inputs_qwen = self.sub_qwen_proj(query_output.last_hidden_state)
