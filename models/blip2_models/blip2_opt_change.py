...
#
# client = Ark(api_key='b90098fa-2410-42cb-b3d5-f81e9e6a079b')
import json
import os
...
#client = OpenAI(api_key="sk-245650db6cb64d818bf74570800e8428", base_url="https://api.deepseek.com")
##星火认知大模型Spark Max的URL值，其他版本大模型URL值请前往文档（https://www.xfyun.cn/doc/spark/Web.html）查看
#SPARKAI_URL = 'wss://spark-api.xf-yun.com/v3.5/chat'
##星火认知大模型调用秘钥信息，请前往讯飞开放平台控制台（https://console.xfyun.cn/services/bm35）查看
#SPARKAI_APP_ID = 'b04dcaeb'
#SPARKAI_API_SECRET = 'OTcwZmJhNDI3NWExNGQ4ZDY4ZWFjY2Qy'
#SPARKAI_API_KEY = 'b6e67b4a785748c1ce6a93ec39e17711'
...
#
    ...
    def generate(
        ...
        image = image.permute(0, 2, 1, 3, 4).reshape(B * T, C, H, W)
        with self.maybe_autocast():
            image_embeds = self.ln_vision(self.visual_encoder(image))  # 图像特征
        ...
        # 结合图像和情感的特征
        query_output.last_hidden_state = torch.cat((query_output.last_hidden_state, emo_class_fea.last_hidden_state),
                                                   dim=1)
        ...
        # 获取 GLM 输入嵌入
        inputs_embeds = self.glm_model.get_input_embeddings()(opt_tokens.input_ids)
        inputs_embeds = torch.cat([inputs_opt, inputs_embeds], dim=1)
